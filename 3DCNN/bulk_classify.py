...
sensor_cols = ["X1", "X2", "X3", "CM", "O1", "O2", "A1", "A2", "Fp1", "Fp2", "T5", "T6", "F7", "F8", "T3", "T4", "P3", "P4", "F3", "F4", "Cz", "Fz", "C3", "C4"]
...
drop_cols_16 = [*settings.DROP_COLUMNS, "Fp2", "T5", "C3", "T4", "O2", "A1", "A2", "O1"]
drop_cols_12 = [*drop_cols_16, "X1", "Fp1", "X2", "T6"]
...
model_args = [
    ...
    ("passive_20_col",                  {"force_training":force_training, "max_epochs":20,  "early_stopping":False, "batch_size":32, "frames_per_timeslice":20,  "data_location":'_data_passive', "model_file_name":'passive_20_col.h5',                    "model_weights_file_name":'passive_20_col_weights.h5',                  "use_fourier":False, "fourier_append":False, "drop_columns":drop_cols_20, "num_columns":5, "num_rows":4}),
    ...
    ("passive_9_col",                   {"force_training":force_training, "max_epochs":20,  "early_stopping":False, "batch_size":32, "frames_per_timeslice":20,  "data_location":'_data_passive', "model_file_name":'passive_9_col.h5',                     "model_weights_file_name":'passive_9_col_weights.h5',                   "use_fourier":False, "fourier_append":False, "drop_columns":drop_cols_9,  "num_columns":3, "num_rows":3}),
    ...
    ("passive_4_col",                   {"force_training":force_training, "max_epochs":20,  "early_stopping":False, "batch_size":32, "frames_per_timeslice":20,  "data_location":'_data_passive', "model_file_name":'passive_4_col.h5',                     "model_weights_file_name":'passive_4_col_weights.h5',                   "use_fourier":False, "fourier_append":False, "drop_columns":drop_cols_4,  "num_columns":2, "num_rows":2}),
    ...
    ("active_20_col",                   {"force_training":force_training, "max_epochs":20,  "early_stopping":False, "batch_size":32, "frames_per_timeslice":20,  "data_location":'_data_active',  "model_file_name":'active_20_col.h5',                     "model_weights_file_name":'active_20_col_weights.h5',                   "use_fourier":False, "fourier_append":False, "drop_columns":drop_cols_20, "num_columns":5, "num_rows":4}),
    ...
    ("active_9_col",                    {"force_training":force_training, "max_epochs":20,  "early_stopping":False, "batch_size":32, "frames_per_timeslice":20,  "data_location":'_data_active',  "model_file_name":'active_9_col.h5',                      "model_weights_file_name":'active_9_col_weights.h5',                    "use_fourier":False, "fourier_append":False, "drop_columns":drop_cols_9,  "num_columns":3, "num_rows":3}),
    ...
    ("active_4_col",                    {"force_training":force_training, "max_epochs":20,  "early_stopping":False, "batch_size":32, "frames_per_timeslice":20,  "data_location":'_data_active',  "model_file_name":'active_4_col.h5',                      "model_weights_file_name":'active_4_col_weights.h5',                    "use_fourier":False, "fourier_append":False, "drop_columns":drop_cols_4,  "num_columns":2, "num_rows":2}),
